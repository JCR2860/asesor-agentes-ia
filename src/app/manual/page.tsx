...
export default function ManualPage() {
    ...
    const sections = [
        ...
        },
        {
            ...
            title: language === 'es' ? "4. Guía Maestra y Bóveda de Plantillas" : "4. Master Guide and Template Vault",
            content: language === 'es'
                ? "Una formulación vaga resultará en un consejo débil. Para anular este riesgo, dispones de dos herramientas clave:\n\n• La Guía Maestra: Una biblioteca con más de 560 Consultas de Referencia diseñadas por abogados. Filtra para hallar un caso similar al tuyo y úsalo como base.\n\n• Bóveda de Plantillas: Acceso exclusivo a estructuras de contratos y documentos legales premium listos para personalizar. \n\nAmbos recursos aseguran que el Agente trabaje sobre un estándar profesional, garantizando un rendimiento óptimo de tu consulta."
                : "A vague formulation will result in weak advice. To nullify this risk, you have two key tools:\n\n• The Master Guide: A library with over 560 Reference Queries designed by lawyers. Filter to find a case similar to yours and use it as a base.\n\n• Template Vault: Exclusive access to premium contract structures and legal documents ready to customize.\n\nBoth resources ensure the Agent works on a professional standard, guaranteeing optimal performance of your query."
        },
        {
