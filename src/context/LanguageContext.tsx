...
export const translations: Record<Language, Record<string, string>> = {
    es: {
        ...
        "chat.warning": "Atención: Cada vez que pulsas la flecha azul se consume 1 consulta de tu saldo. Por favor, asegúrate de escribir tu consulta de forma detallada (usando Enter para saltos de línea) antes de enviarla.",
        ...
        "chat.error.empty.desc": "Ya has utilizado tus consultas disponibles. Por favor, haz clic en 'Comprar' en el menú superior para recargar tu cuenta.",
    ...
    en: {
        ...
        "chat.btn.send": "Send",
        "chat.warning": "Warning: Every time you press the blue arrow, 1 query is consumed from your balance. Please make sure to write your query in detail (using Enter for line breaks) before sending.",
        ...
        "chat.error.empty.desc": "You have used all your available queries. Please click 'Buy' in the top menu to recharge your account.",
