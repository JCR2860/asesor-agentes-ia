...
export const translations: Record<Language, Record<string, string>> = {
    es: {
        ...
        "hero.desc": "El ecosistema legal definitivo:\n• 14 Asesores IA especializados\n• Bóveda de plantillas legales premium\n• 560+ Consultas de Referencia\n\nTodo en un solo lugar, disponible 24/7 sin esperas.",
        "hero.btn.start": "Comenzar Análisis (Desde 9,50€)",
        "hero.btn.sub": "Accede a 14 ramas del derecho en segundos.",
        ...
        "how.step2.desc": "Una vez en el despacho, sube tus contratos, fotos o explica tu situación. Nuestros modelos de élite cruzarán datos con legislación actualizada en tiempo real.",
        ...
        "agent.ciber.sub": "Experto en Ciberseguridad y Peritaje Informático",
        "agent.ciber.desc": "Auditor de brechas de seguridad corporativas, cumplimiento normativo NIS2/GDPR, espionaje industrial y validez legal de pruebas tecnológicas (peritaje). Protege tu infraestructura digital frente a cibercrimen.",
        "agent.comercio.sub": "Consultor de Comercio Internacional y Aduanas",
        "agent.comercio.desc": "Especialista en Incoterms, aranceles, normativas aduaneras de importación/exportación y estructuración de cadenas de suministro globales. Asegura tus operaciones transfronterizas frente a riesgos regulatorios.",
        "agent.subvenciones.sub": "Estratega de Financiación y Fondos Europeos",
        "agent.subvenciones.desc": "Arquitecto en captación de Fondos Next Generation, subvenciones públicas, líneas ENISA y estructuración financiera para Startups. Maximiza la liquidez de tu proyecto accediendo a capital institucional.",
        "agent.medioambiente.sub": "Asesor Medioambiental y Cumplimiento ESG",
        "agent.medioambiente.desc": "Especialista en bonos de carbono, normativas de impacto ambiental, sostenibilidad corporativa (ESG) y licencias ecológicas. Adapta tu empresa a las estrictas directivas europeas de transición verde.",
        ...
        "pricing.badge1.text": "25 Consultas por 9,50€",
        "pricing.badge2.text": "50 Consultas por 16,50€",
        "pricing.badge3.text": "100 Consultas por 29,50€",
        "pricing.box1.title": "Comienza Hoy",
        "pricing.box1.desc": "Regístrate y adquiere tu pack desde 9,50€ o canjea tu código personal.",
        ...
        "guide.desc": "Estás ante la IA jurídica más avanzada del mercado. Al adquirir un pack de consultas, tendrás acceso ilimitado a nuestra Guía Maestra con más de 560 Consultas de Referencia y estrategias reales para:",
        ...
        "faq.notfound.desc": "Nuestros 14 asesores IA especializados pueden responder cualquier consulta legal. Disponibles 24 horas, 7 días a la semana.",
        ...
        "chat.legal_warning": "⚠️ SESIÓN DE ORIENTACIÓN IA: Esta consulta tiene carácter informativo y de pre-diagnóstico. Para trámites legales oficiales, representación o defensa vinculante, es IMPRESCINDIBLE acudir a un abogado o asesor colegiado.",
        "chat.input.placeholder": "Describe tu problema o consulta para el ",
        "chat.btn.send": "Enviar",
        "chat.warning": "⚠️ Cada envío consume 1 crédito (3 con la Directora). Detalla tu consulta al máximo para optimizar tu saldo.",
        ...
        "chat.error.limit.desc": "Has alcanzado el límite de mensajes gratuitos para esta sesión. Por favor, vuelve al inicio e inicia una nueva sesión de consulta.",
        ...
        "recepcion.handoff.warn": "Al iniciar, se descontarán 3 créditos de su saldo (sesión con la Directora).",
        ...
        "guide.modal.cost": "Consumo: 1 Crédito (o 3 con la Directora)",
        ...
        "hero.c.docs.title": "Bóveda de Documentos",
        "hero.c.docs.desc": "Descarga directa de contratos y plantillas jurídicas profesionales de alta fidelidad sin chatear.",
        "hero.c.docs.btn": "Entrar a la Bóveda",
        ...
        "home.cta.sub": "Sin suscripciones • Sin esperas • Precisión de Élite",
        ...
        "hero.guide_desc_cta": "Inspírese en 560 casos reales de éxito legal",
        ...
        "agent.title.ciber": "Asesor de Ciberseguridad",
        "agent.title.comercio": "Asesor de Comercio Internacional",
        "agent.title.subvenciones": "Asesor de Subvenciones",
        "agent.title.medioambiente": "Asesor Medioambiental",
        "agent.brand.fiscal": "LexTributo",
        "agent.brand.extra": "GlobalVisa",
        "agent.brand.merc": "CorpLex",
        "agent.brand.lab": "Laboris",
        "agent.brand.penal": "PenalShield",
        "agent.brand.aero": "AeroLex",
        "agent.brand.civil": "Civilitas",
        "agent.brand.pi": "IPGuard",
        "agent.brand.inmo": "EstateLex",
        "agent.brand.cripto": "CryptoLex",
        "agent.brand.ciber": "CyberLex",
        "agent.brand.comercio": "TradeLex",
        "agent.brand.subvenciones": "GrantLex",
        "agent.brand.medioambiente": "EcoLex",
    ...
    en: {
        ...
        "hero.desc": "The ultimate legal ecosystem:\n• 14 specialized AI Advisors\n• Premium legal template Vault\n• Library of 560+ Reference Queries\n\nAll in one place, available 24/7 without waiting.",
        "hero.btn.start": "Start Analysis (From €9.50)",
        "hero.btn.sub": "Access 14 branches of law in seconds.",
        ...
        "how.step2.desc": "Once in your office, upload your contracts, photos or explain your situation. Our elite models will cross-reference updated legislation in real time.",
        ...
        "agent.ciber.sub": "Cybersecurity & Digital Forensics Expert",
        "agent.ciber.desc": "Auditor for corporate security breaches, NIS2/GDPR compliance, industrial espionage, and legal validity of technological evidence (forensics). Protects your digital infrastructure against cybercrime.",
        "agent.comercio.sub": "International Trade & Customs Consultant",
        "agent.comercio.desc": "Specialist in Incoterms, tariffs, import/export customs regulations, and global supply chain structuring. Secures your cross-border operations against regulatory risks.",
        "agent.subvenciones.sub": "Funding & European Grants Strategist",
        "agent.subvenciones.desc": "Architect in securing Next Generation Funds, public grants, ENISA loans, and financial structuring for Startups. Maximizes your project's liquidity by accessing institutional capital.",
        "agent.medioambiente.sub": "Environmental & ESG Compliance Advisor",
        "agent.medioambiente.desc": "Specialist in carbon credits, environmental impact regulations, corporate sustainability (ESG), and ecological licenses. Adapts your company to strict European green transition directives.",
        ...
        "pricing.badge1.text": "25 Queries for €9.50",
        "pricing.badge2.text": "50 Queries for €16.50",
        "pricing.badge3.text": "100 Queries for €29.50",
        "pricing.box1.title": "Start Today",
        "pricing.box1.desc": "Register and acquire your pack from €9.50 or redeem your personal code.",
        ...
        "guide.desc": "You are using the most advanced legal AI on the market. By acquiring a query pack, you will have unlimited access to our Master Guide with over 560 Reference Queries and real strategies for:",
        ...
        "faq.notfound.desc": "Our 14 specialized AI advisors can answer any legal query. Available 24 hours a day, 7 days a week.",
        ...
        "chat.legal_warning": "⚠️ AI ORIENTATION SESSION: This inquiry is for informational and pre-diagnostic purposes. For official legal procedures, representation, or binding defense, it is ESSENTIAL to consult a licensed lawyer or advisor.",
        "chat.input.placeholder": "Describe your problem or query for ",
        "chat.btn.send": "Send",
        "chat.warning": "⚠️ Each send consumes 1 credit (3 for the Director). Detail your query as much as possible to optimize your balance.",
        ...
        "chat.error.limit.desc": "You have reached the limit of free messages for this session. Please go back to start and initiate a new consultation session.",
        ...
        "recepcion.handoff.warn": "Upon starting, 3 credits will be deducted from your balance (Director session).",
        ...
        "guide.modal.cost": "Cost: 1 Credit (or 3 for the Director)",
        ...
        "hero.c.docs.title": "Document Room",
        "hero.c.docs.desc": "Instant legal generator for ready-to-sign contracts and documents without chatting.",
        "hero.c.docs.btn": "Generate Documents",
        "hero.c.mod_b.title": "MODE B (Master Guide)",
        ...
        "home.cta.sub": "No subscriptions • No waiting • Elite Precision",
        ...
        "hero.guide_desc_cta": "Get inspired by 560 real legal success cases",
        ...
        "agent.title.ciber": "Cybersecurity Advisor",
        "agent.title.comercio": "International Trade Advisor",
        "agent.title.subvenciones": "Grants Advisor",
        "agent.title.medioambiente": "Environmental Advisor",
        "agent.brand.fiscal": "LexTributo",
        "agent.brand.extra": "GlobalVisa",
        "agent.brand.merc": "CorpLex",
        "agent.brand.lab": "Laboris",
