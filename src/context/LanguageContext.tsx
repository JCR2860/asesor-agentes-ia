...
export const translations: Record<Language, Record<string, string>> = {
    es: {
        ...
        "guide.step2.title": "2. Sube tus Contratos o Fotos (PDF/IMG)",
        ...
        "guide.page.subtitle": "Copia las preguntas recomendadas para obtener el mejor pre-diagnóstico de nuestros especialistas.",
    ...
    en: {
        ...
        "guide.step2.title": "2. Upload your Contracts or Photos (PDF/IMG)",
        ...
        "guide.page.subtitle": "Copy the recommended questions to get the best pre-diagnosis from our specialists.",
